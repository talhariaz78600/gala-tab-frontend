            ...
            <div className="mycontainer h-full flex flex-col justify-center items-center">
                <div className='grid md:grid-cols-2 lg:gap-24 gap-6'>
                    <div className='py-3'>
                        ...
                        <div className='mt-4'>
                            <Link to="/admin-dashboard/stepper-service" className='bg-black text-white rounded-full w-36 flex items-center text-center justify-between gap-2 py-2 ps-4 pe-2' >Get Started <FaArrowRight className='text-white border-2 border-black bg-gradient-to-r from-[#1c1c1c] to-[#757575] p-2 text-3xl rounded-full'/></Link>
                        </div>
                    </div>
                    <div>
                       <div>
