    ...
    <div className="py-7 w-full">
      <div className="">
        ...
        <p className="text-center mt-4">
          We’ll need you to add an official government ID.<br></br>
        ...
        <div className="sm:max-w-3xl  mx-auto md:mt-12 mt-5">
          ...
          <div className="mt-3 bg-[#F7F7F7] py-4 px-4 rounded-lg">
            ...
            <p className="text-center">
              ...
              safe, and secure.{" "}
              <Link className="underline text-[#3551B6]">Learn more</Link>
            </p>
            <div className="flex md:flex-row flex-col items-center gap-3 mt-4">
              <div className="w-full">
                <Link className="underline block text-center w-full py-2 rounded-lg border border-black">
                  Privacy Policy.
                </Link>
              </div>
              <div className="w-full">
                <Link className="underline w-full text-center block py-2 rounded-lg border border-black">
