  ...
  return (
    <div className='py-12'>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                <div>
                    <p className='text-[#202529] bg-[#E7E7E7] border rounded-full w-[fit-content] px-5 py-2'>Step 08</p>
                    <div>
                        <h2 className='text-[#171717] font-bold lg:text-5xl text-3xl mt-5'>Write a Venue Description!</h2>
                        <p className='text-[#171717] mt-3 text-lg'>Tell guests what makes your place unique - share the magic!</p>
                    </div>
                </div>
                <div>
                    <div>
                        <label htmlFor="serviceTitle" className='text-[#202529] text-sm font-medium ml-4'>Venue Description Title</label>
                        <input 
                            id="serviceTitle" 
                            type="text" 
