...
export default function NewBookingService() {
  const ListingItems = [
    {
      text: "Catering",
      image: decoration,
      ...
      <div className="mt-16">
        <div className="mycontainer">
          <div className="max-w-[800px] mx-auto">
            <p className="text-[28px] sm:text-[32px] md:text-[40px] font-bold text-center">
            Welcome A New Booking, Kevin
            </p>
            <div className="mt-8">
                    ...
                    <div className="flex items-center gap-4 justify-between border-b pb-4 mb-4">
                      ...
                      <div className="flex items-center gap-6 ms-auto">
                        <div className="flex items-center gap-2">
                          <GoDotFill className="text-[#34A853]" />
