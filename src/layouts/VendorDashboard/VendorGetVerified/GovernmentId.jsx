    ...
    <div className='py-7 w-full'>
        <div className=''>
            ...
            <div className='sm:max-w-3xl  mx-auto md:mt-12 mt-5'>
                <div className='bg-[#F7F7F7] w-full py-4 border rounded-lg px-4 flex flex-wrap gap-3 items-center justify-between'>
                    <div>
                ...
                <div className='mt-3 bg-[#F7F7F7] py-4 px-4 rounded-lg'>
                    ...
                    <div className='flex md:flex-row flex-col items-center gap-3 mt-4'>
                        <div className='w-full'>
                            <Link to="#" className='underline block text-center bg-white w-full py-2 rounded-lg border border-black'>Privacy Policy.</Link>
                        </div>
                        <div className='w-full'>
                            <Link to="#" className='underline w-full text-center bg-white block py-2 rounded-lg border border-black'>How identity verification works.</Link>
                        </div>
                    </div>
                </div>
            </div>
