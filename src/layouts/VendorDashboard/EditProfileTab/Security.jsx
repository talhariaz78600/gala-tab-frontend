...
const Security = () => {
  ...
  return (
    <div className="h-full">
      <form className="h-full" action="/vendor-dashboard/Vendor-Profile">
        <div className="h-full flex flex-col justify-between">
          <div>
            <div className="flex items-center gap-2">
              <div>
                <Link to="/vendor-dashboard/Vendor-Profile"><IoMdArrowRoundBack className="bg-white text-black p-2 shadow-sm rounded-full text-4xl" /></Link>
              </div>
          ...
          <div className="grid lg:grid-cols-2 max-w-[500px] gap-3 mt-12">
            <button
              onClick={() => goto("/vendor-dashboard/Vendor-Profile")}
              type="button"
