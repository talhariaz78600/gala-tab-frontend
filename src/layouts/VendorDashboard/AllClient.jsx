    ...
    return (
        <div>
            <div className='bg-[#F7F7F7] rounded-lg'>
                <h4 className='text-2xl font-semibold p-3 border-b'>All Clients</h4>
                <div className='p-3'>
                                    ...
                                    <tr key={row.index} id={`row-${index + 1}`}>
                                        ...
                                        <td className="p-4 bg-white rounded-e-[10px]">
                                            <div className="flex items-center gap-2">
                                                <Link to="/vendor-dashboard/client-profile" className='bg-black text-white py-2 px-5 rounded-lg sm:text-lg'>
                                                    View Detail
                                                </Link>
                                            </div>
                                        </td>
