...
export default function UserTaxRequirements() {
  const forms = [
    {
      id: "w9",
      title: "Form W-9",
      ...
      <div className="mt-8">
        <div className="mycontainer">
          <div className="flex items-center">
            <Link to="/user-dashboard/user-account" className="text-[28px] leading-normal font-semibold">
              Account
            </Link>
          ...
          <div className="mt-6 border-b border-[#CDCDCD] pb-6">
            ...
            <div className="flex flex-wrap gap-4 items-center justify-between mt-6 text-lg">
              ...
              <div className="ms-auto">
                <Link className="py-2 px-8 bg-black text-white inline-block text-lg rounded-[10px]">
                  Help Center
                </Link>
              </div>
            </div>
