...
export default function UserFormW9() {
        ...
        <div className="mycontainer">
          <div>
            <div className="flex justify-between items-center">
              <p className="sm:text-[28px] text-lg font-semibold">Add tax info</p>
              <Link to="/User-dashboard/User-account">
          ...
          <div className="py-12 px-4 bg-[#F7F7F7] rounded-[10px] mt-5">
            <form action="">
              <div className="max-w-[700px] mx-auto">
                <p className="leading-normal font-semibold sm:text-[28px] text-lg">
                  Substitute Form W-9
                </p>
                <div className="mt-5">
                  ...
                  <input
                    className="block border w-full sm:px-4 sm:py-6 p-3 border-[#D5D5D5] invalid:bg-[#C135151A] invalid:border-[#C13515] rounded-[10px] shadow-[0px_8px_24px_0px_#00000012]"
                    required
                    type="text"
                    name="businessname"
                    id="businessname"
                ...
                <div className="mt-5">
                  ...
                  <input
                    className="block border w-full sm:px-4 sm:py-6 p-3 border-[#D5D5D5] rounded-[10px] shadow-[0px_8px_24px_0px_#00000012]"
                    type="text"
                ...
                <div className="mt-5">
                  ...
                  <select
                    className="block border w-full sm:px-4 sm:py-6 p-3 border-[#D5D5D5] rounded-[10px] shadow-[0px_8px_24px_0px_#00000012] focus:outline-none "
