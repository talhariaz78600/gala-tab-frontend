  ...
  return (
    <div className="landing-page-tab-card w-full sm:w-1/2 md:w-1/3 min-[992px]:w-1/4 min-[1200px]:w-1/5 p-3">
      <div
        ...
        className="border p-2 rounded-[10px] bg-white dark:bg-gray-800 cursor-pointer"
      >
        <div className="relative">
          ...
          <div className="absolute p-2 bg-[rgba(255,255,255,.9)] top-[8px] left-[8px] rounded-[5px]">
            <p className="text-xs font-medium text-black">Verified listing</p>
          </div>
          {user && (
