      ...
      >
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-[700px] bg-white rounded-[20px]">
          <div className="rounded-[20px] overflow-hidden shadow-[0px_0px_17px_0px_#ECECEC]">
            ...
            <form action="">
              <div className="py-1">
                <div className="p-5 grid min-[480px]:grid-cols-2 md:grid-cols-3 gap-5 max-h-[calc(100dvh-220px)] scroll-x-hidden overflow-y-auto">
