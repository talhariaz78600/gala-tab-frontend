...
export default function UserHelp() {
  const data = [
    ...
    {
      parent: "Managing your experience",
      children: {
        child1: "Calendar and bookings",
        child2: "Updating your experience page",
        child3: "Pricing",
        child4: "Marketing and promotion",
      },
    },
    {
      parent: "Payments, pricing, and refunds",
      children: {
        child1: "Paying for a Vendor",
        child2: "Refunds",
        child3: "Pricing and fees",
        child4: "Invoices and receipts",
        child5: "Tax Forms",
      },
    },
  ];
