...
export default function FindListingModalActive() {
          ...
          <div className="py-1">
            <div className="p-4 max-h-[calc(100dvh-200px)] overflow-y-auto scroll-x-hidden">
              ...
              <div className="flex flex-wrap flex-col gap-4 justify-center sm:justify-between mt-8">
                <Link to="/admin-dashboard/service-management" className="bg-[#1C1C1C] flex justify-center border border-[#1C1C1C] rounded-[10px] py-3 text-lg px-6 font-medium text-white shadow-[0px_10px_17px_0px_#FD636312]">
                  Edit listing
                </Link>
