...
export default function PrivacyAndSharing() {
  return (
    <div>
      <p className="text-[28px] font-semibold">Privacy and sharing</p>
      <div className="border-b border-[#CDCDCD] pb-5 mt-4">
        <p className="font-semibold text-[20px]">Activity sharing</p>
      ...
      <div className="border-b border-[#CDCDCD] pb-5 mt-4 flex justify-between items-center gap-4 flex-wrap-reverse">
        <div>
          <p className="font-semibold text-[20px]">Read Receipts</p>
          <p className="text-lg mt-3">
