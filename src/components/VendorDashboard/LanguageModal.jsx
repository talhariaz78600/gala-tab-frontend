      ...
      >
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-[700px] bg-white dark:bg-gray-800 rounded-[20px]">
          <div className="p-4 flex justify-between items-center flex-wrap-reverse border-b border-[#CDCDCD]">
            <p className="sm:text-[26px] font-semibold">Preferred language</p>
            <button>
              <RiCloseCircleFill
          ...
          <div className="p-4">
            <p className="sm:text-lg">
              This updates what you read on{" "}
              <Link className="text-[#3551B6] font-semibold">Gala Tab</Link>,
            ...
            <select
              ...
              className="mt-6 w-full sm:p-6 p-3 pe-12 border focus:outline-none border-[#D4D7E3] text-black rounded-[10px] bg-no-repeat appearance-none"
              name="Language"
              id="Language"
            >
